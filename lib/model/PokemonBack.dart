...
PokemonBack pokemonBackFromJson(String str) => PokemonBack.fromJson(json.decode(str));

String pokemonBackToJson(PokemonBack data) => json.encode(data.toJson());
...
class PokemonBack {
    ...
    factory PokemonBack.fromJson(Map<String, dynamic> json) => PokemonBack(
